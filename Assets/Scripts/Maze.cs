...
public class Maze : MonoBehaviour 
{
	...
	private MazeCell CreateCell (IntVector2 coordinates) 
	{
		...
		Pellet newPellet = Instantiate(pelletPrefab);
		var pos =  new Vector3(coordinates.x - size.x * 0.5f + 0.5f, 0f, coordinates.z - size.z * 0.5f + 0.5f);
		...
		newPellet.transform.position = pos + new Vector3(0, 0.8f, 0);
